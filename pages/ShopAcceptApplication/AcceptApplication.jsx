  ...
  return (
    ...
    <HeaderAdmin />
        ...
        <div className='title__list-item'>
            ...
            <div className='left-down_container-item'>
                  ...
                  <table>
                    <thead>
                      <tr id="selectAll">
                        ...
                        <th> Склад </th>
                        <th> Количество </th>
                        <th style={{display: 'flex', marginLeft: '250px'}}>Действие</th>
                      </tr>
                    </thead>
                    ...
                    {application.map((item) =>(
                      <tr key={application.id === item['#']}>
                        ...
                        <th>{item['Склад']}</th>
                        <th>{item['Остаток']}</th>
                        <th style={{display: 'flex', marginLeft: '250px'}}> 
                       
                         <div onClick={handleOpenForm}>
                            <button className='btn-actions' onClick={() => handleActionClick(application)}>
                                <span>{item['Действие']}</span>
