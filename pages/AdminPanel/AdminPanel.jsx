    ...
    <HeaderAdmin />
      ...
      <div className='title-list-application' style={{backgroundColor: "#fff"}}>
        <div className='container'style={{backgroundColor: "#fff"}}>
          <h1 style={{ alignItems: "center", justifyContent:"center", textAlign:"center", paddingTop: "22px", backgroundColor: "#fff"}}>Ваши заявки на продукты</h1>
        </div>
        </div>
        ...
        <div className='main-table'>
            <div className='title-list'>
              ...
              <div className='left-title-list'>
                <p style={{fontSize: "14.67px", marginRight: "40px",  marginTop: "12px"}}>Количество заявок: <span>576</span></p>
                <button className='applicaation-btn'>Создать заявку</button>
              </div>
              </div>
